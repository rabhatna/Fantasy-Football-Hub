...
import { Check, Copy, FileUp, Loader2, Lock, Search, X } from "lucide-react";
import {
  ...
  return (
    <Panel testId="panel-keeper-upload">
      ...
      <p className="mt-2 text-[10px] leading-4 text-muted-foreground">
        ...
        <span className="mono">dollars</span> for auction ones.
      </p>
 ...
 * the available pool, and the suggestions.
 */
  ...
  return (
    <div className="mx-auto max-w-[1100px]">
      ...
      <div className="grid gap-6 lg:grid-cols-[minmax(0,5fr)_minmax(0,7fr)]">
        ...
        <div className="space-y-6">
          <SheetUpload onDone={refreshKeepers} />
          <AddKeeper keptIds={keptIds} onDone={refreshKeepers} />
